...
public interface GiveFookUkClient {
    // TODO-3: refer `https://www.givefood.org.uk/api` and make `GiveFoodUkClientImpl` class that implements this
    //  interface in a new package called `impl` in this (`client`) package.
