// TODO-0(Jacky): get rid of `lib/` folder as Spring handles all json serialization and deserialization.
...
public class Gw1Application {
    ...
    // TODO-1(Jacky): This method should only contain the line 14 and nothing else
